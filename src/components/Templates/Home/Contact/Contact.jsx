        ...
        <div className='my-20'>
          <Container>
            ...
            >
              ...
              <div className='flex items-center max-w-2xl mx-auto justify-center pt-20'>
                <div className='relative w-[400px] shadow-lg rounded-lg mr-10'>
                  <input
                ...
                <div>
                  <motion.button
                    ...
                    className='bg-gradient-to-t from-[#FF946D] to-[#FF7D68] px-10 py-5 text-white rounded-xl'
                  >
                    Subscribe
                  </motion.button>
                </div>
              </div>
              <motion.div className='absolute right-0 top-0 -z-10 grayscale '>
                <img src={RightDecor} />
              </motion.div>
